...
[simout,simout1] = apply_IQ_imbal(signal2.simout, A);
...
corrected_signal = imbalance_correction(simout, A, 0);
...
figure('Name','Real part of corrected signal vs real part of corrected signal','NumberTitle','off');
